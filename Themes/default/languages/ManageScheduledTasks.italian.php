...
$txt['scheduled_tasks_time_offset'] = '<strong>Nota:</strong> Tutti gli orari indicati qui in basso sono relativi <em>all\'orario del server</em> e non tengono conto delle impostazioni di fuso orario degli account.';
...
$txt['scheduled_task_fetchSMfiles'] = 'Carica i file Simple Machines';
$txt['scheduled_task_desc_fetchSMfiles'] = 'Carica i file javascript contenenti le notifiche degli aggiornamenti ed altre informazioni.';
