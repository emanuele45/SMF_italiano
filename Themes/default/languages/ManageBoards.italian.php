...
$txt['boards_and_cats_desc'] = 'Qui puoi modificare sezioni e categorie. Aggiungi più moderatori in questo modo <em>&quot;nome utente&quot;, &quot;nome utente&quot;</em>. (devono essere nomi utenti, non nomi visualizati!)<br />Per creare una nuova sezione, clicca sul bottone "Crea Sezione". Per renderla una sottosezione di una già esistente, seleziona "Sottosezione di..." dal menu a tendina "Ordine" visualizzato durante la creazione della sezione.';
$txt['parent_members_only'] = 'Utenti normali';
$txt['parent_guests_only'] = 'Utenti non registrati';
...
$txt['mboards_order_inside'] = 'All\'interno di ';
...
$txt['mboards_delete_board_contains'] = 'Eliminando questa sezione verranno spostate anche le sottosezioni contenute, compresi tutti i topic, i post e gli allegati all\'interno di ogni sottosezione';
$txt['mboards_delete_board_option1'] = 'Elimina la sezione e sposta le sottosezioni in essa contenute al livello categoria.';
...
$txt['mboards_description_desc'] = 'Breve descrizione della sezione.';
...
$txt['mboards_count_posts'] = 'Calcola i post';
...
$txt['mboards_redirect_url_desc'] = 'Ad esempio: "http://www.simplemachines.org".';
...
$txt['mboards_recycle_disabled_delete'] = 'Nota: Devi selezionare un altro cestino o disabilitarne la funzione prima di poter rimuovere questa sezione.';
...
$txt['mboards_settings_submit'] = 'Salva';
