...
$txt['notes_file'] = 'File di istruzioni/note aggiuntive';
$txt['list_file'] = 'Elenca i file nel pacchetto MOD';
$txt['files_archive'] = 'File contenuti nell\'archivio';
$txt['package_get'] = 'Recupera pacchetto MOD';
$txt['package_servers'] = 'Server dedicato alle MOD';
...
$txt['install_mod'] = 'Installa MOD';
$txt['uninstall_mod'] = 'Disinstalla MOD';
$txt['sql_file'] = 'File di modifica estratto. Questa modifica viene fornita con un file SQL contenente le variazioni necessarie al database. Come prima cosa, dovresti quindi eseguirlo.';
$txt['sql_queries'] = 'Query SQL';
$txt['no_mods_installed'] = 'Nessuna MOD installata al momento';
...
$txt['package_manager_desc'] = 'Da "Gestione MOD" è possibile scaricare e installare modifiche al forum tramite un\'interfaccia molto intuitiva e semplice da utilizzare.';
...
$txt['download_packages_desc'] = 'Da questa sezione è possibile scegliere sia di scaricare nuove MOD dal server, sia di caricare un file direttamente sul forum.';

$txt['create_package'] = 'Crea un nuovo pacchetto';
$txt['download_new_package'] = 'Scarica un nuovo pacchetto';
$txt['view_and_remove'] = 'Visualizza ed elimina i pacchetti installati';
$txt['modification_package'] = 'Pacchetti MOD';
$txt['avatar_package'] = 'Pacchetti avatar';
$txt['language_package'] = 'Pacchetti di traduzioni';
$txt['unknown_package'] = 'Pacchetti sconosciuti';
$txt['use_avatars'] = 'Utilizzare avatar';
$txt['add_languages'] = 'Aggiungi lingua';
$txt['list_files'] = 'Elenco dei file';
$txt['remove'] = 'Elimina';
$txt['package_type'] = 'Tipo di pacchetto';
$txt['archiving'] = 'Archiviazione in corso';
$txt['extracting'] = 'Estrazione in corso';
$txt['avatars_extracted'] = 'Gli avatar sono stati estratti e sono ora utilizzabili.';
$txt['language_extracted'] = 'La traduzione è stata estratta ed è ora utilizzabile (tramite il pannello impostazioni).';

$txt['mod_name'] = 'Nome MOD';
...
$txt['file_location'] = 'Percorso del file';

$txt['package_installed_key'] = 'Pacchetti installati:';
...
$txt['packages_latest'] = 'Pacchetti più recenti';
$txt['packages_latest_fetch'] = 'Ricerca in corso dei pacchetti più popolari e recenti da www.simplemachines.org...';
...
$txt['perform_actions'] = 'L\'installazione di questo pacchetto eseguirà le seguenti azioni:';
$txt['corrupt_compatible'] = 'Il pacchetto che stai tentando di scaricare o installare è corrotto o non compatibile con questa versione di SMF.';
$txt['package_create'] = 'Crea';
$txt['package_move'] = 'Muovi';
$txt['package_delete'] = 'Elimina';
...
$txt['package_other_themes_uninstall'] = 'Disinstalla dagli altri temi';
$txt['package_other_themes_desc'] = 'Per utilizzare questa MOD in altri temi oltre a quello default, il gestore pacchetti dovrà effettuare ulteriori modifiche. Se vuoi procedere, seleziona in basso i temi da modificare.';
// Don't use entities in the below string.
...
$txt['package_uninstall_done'] = 'Il pacchetto è stato disinstallato e non dovrebbe avere più effetto.';
...
$txt['package_ftp_why_download'] = 'Per scaricare i pacchetti, la cartella Packages e i file in essa contenuti devono essere accessibili in scrittura, mentre al momento non lo sono. La gestione pacchetti può utilizzare i dati di accesso FTP personali per sistemare il problema.';
$txt['package_ftp_server'] = 'Server FTP';
$txt['package_ftp_port'] = 'Porta';
$txt['package_ftp_username'] = 'Nome utente';
$txt['package_ftp_password'] = 'Password';
$txt['package_ftp_path'] = 'Percorso locale di SMF';
...
$txt['package_modification_malformed'] = 'File di modifica malformato o non valido.';
...
$txt['package_db_uninstall'] = 'Cancella tutti i dati relativi a questa modifica.';
$txt['package_db_uninstall_details'] = 'Dettagli';
$txt['package_db_uninstall_actions'] = 'Selezionando questa opzione, verranno effettuati i seguenti cambiamenti nel database';
...
$txt['package_advanced_button'] = 'Avanzato';
...
$txt['package_file_perms_name'] = 'File/Nome cartella';
$txt['package_file_perms_status'] = 'Stato attuale';
$txt['package_file_perms_new_status'] = 'Nuovo stato';
$txt['package_file_perms_status_read'] = 'Lettura';
...
$txt['package_file_perms_not_writable'] = 'Non scrivibile';
...
$txt['package_file_perms_predefined_note'] = 'N.B: questa opzione applica solamente il profilo predefinito ai file e le cartelle di SMF.';
...
$txt['package_file_perms_ftp_retain'] = 'SMF memorizzerà temporaneamente la password per l\'esecuzione del gestore pacchetti.';
...
$txt['package_restore_permissions'] = 'Ripristina i permessi file';
$txt['package_restore_permissions_desc'] = 'I seguenti permessi file sono stati modificati da SMF per installare i pacchetti selezionati. Per riportare questi file allo stato precedente, fai click &quot;Ripristina&quot; in basso.';
...
$txt['package_restore_permissions_action_success'] = '<span style="color: green;">Riuscito</span>';
$txt['package_restore_permissions_action_failure'] = '<span class="error">Fallito</span>';
$txt['package_restore_permissions_action_done'] = 'SMF ha cercato di ripristinare i seguenti file ai loro permessi originari, i risultati sono presenti in bacco. Se un cambio è fallito, o desideri una visualizzazione dettagliata dei permessi file, vai nella sezione <a href="%1$s">Permessi dei file</a>.';

$txt['package_file_perms_warning'] = 'Fai attenzione';
$txt['package_file_perms_warning_desc'] = '<li>Attenzione a quando si modificano i permessi file da questa sezione - permessi non corretti potrebbero intaccare le funzionalità del tuo forum!</li> <li>In alcune configurazioni server, la selezione dei permessi errati potrebbe impedire ad SMF di funzionare del tutto.</li> <li>Alcune cartelle come <em>attachments</em>, devono essere rese scrivibili per la corretta esecuzione della relativa funzione.</li> <li>Questa possibilità è per lo più applicabile ai server non Windows - non funzionerà come previsto su Windows per quanto riguarda i flag dei permessi.</li> <li>Prima di procedere, assicurati di avere un client FTP installato, in maniera tale da poter rimediare ad eventuali errori collegandoti via FTP al server.</li>';
